...
function Header() {
  return (
    <div className="sticky top-0 z-10 flex justify-between border-b text-gray-200 font-bold border-gray-800 bg-gray-900 px-6 py-4 text-lg">
...
function ViewToggler() {
  return (
    <div className="flex rounded shadow-sm">
      <div className="rounded-l border border-gray-700 bg-gray-800 px-2 py-1">
        <svg className="h-4 w-3">
          <use href={`${icons}#list`} />
        </svg>
      </div>
      <div className="rounded-r border border-gray-700 px-2 py-1">
        <svg className="h-4 w-3">
          <use href={`${icons}#grid`} />
        </svg>
      </div>
...
function IssueLine({ issue }: { issue: Issue }) {
  ...
  return (
    <div
      ...
      className="flex cursor-default justify-between gap-8 border-b border-gray-800 py-3 px-6 text-sm hover:bg-gray-700 bg-gray-800"
    >
      <div className="flex min-w-0 flex-1 items-center gap-2">
        ...
        <Link
          to={`/issues/${issue.id}`}
          tabIndex={0}
          className="flex-1 cursor-default truncate font-medium text-gray-200"
